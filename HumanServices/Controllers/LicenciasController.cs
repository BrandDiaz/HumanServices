...
namespace HumanServices.Controllers
{
    public class LicenciasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LicenciasId,EmpleadoId,Desde,Hasta,Motivos,Comentarios")] Licencias licencias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LicenciasId,EmpleadoId,Desde,Hasta,Motivos,Comentarios")] Licencias licencias)
        {
            if (ModelState.IsValid)
            {
