...
namespace HumanServices.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartamentoId,CodigoDepart,Nombre")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepartamentoId,CodigoDepart,Nombre")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
